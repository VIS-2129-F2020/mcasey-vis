...
ggplot(iso_all_modes) +
  ...
  scale_fill_manual(values = c("cornsilk", "tan2", "tomato4"),
...
ggplot(total_area_walk) +
  annotation_map_tile(type = "cartolight", zoomin = 0, progress = "none") +
  geom_sf(fill = "khaki2", color = "NA", alpha = 0.25) +
...
map_names <- ggplot() +
  ...
  scale_color_manual(values = c("turquoise4", "seagreen3", "salmon3", "yellow", "darkorange1", "turquoise", "violet", "royalblue", "steelblue2", "tan", "darkorchid", "chartreuse", "springgreen", "cyan", "firebrick", "lightgoldenrod", "darkseagreen", "plum", "hotpink", "deeppink", "lightblue", "tomato", "cadetblue", "black", "thistle"), 
                    name = element_blank(),
